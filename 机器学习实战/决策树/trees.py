...
def createDataSet():
    ...
    # 分类属性 return dataSet, labels #返回数据集和分类属性
...
if __name__ == '__main__':
    ...
    myMat, labels = load_data()
    # print(myMat)
    print(calcShannonEnt(myMat))
    # print(splitDataSet(myMat, 0 ,1))
    # print(splitDataSet(myMat, 0, 0))
    # print(splitDataSet(myMat, 1, 1))
